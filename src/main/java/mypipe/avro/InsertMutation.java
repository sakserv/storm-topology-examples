...
public class InsertMutation extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    ...
    @Deprecated public java.util.Map<CharSequence,Integer> integers;
    @Deprecated public java.util.Map<CharSequence,CharSequence> strings;
    @Deprecated public java.util.Map<CharSequence,Long> longs;
     ...
     */
    public InsertMutation(CharSequence database, CharSequence table, Long tableId, java.util.Map<CharSequence, Integer> integers, java.util.Map<CharSequence, CharSequence> strings, java.util.Map<CharSequence, Long> longs) {
    ...
    public void put(int field$, Object value$) {
        switch (field$) {
            ...
            case 3: integers = (java.util.Map<CharSequence,Integer>)value$; break;
            case 4: strings = (java.util.Map<CharSequence,CharSequence>)value$; break;
            case 5: longs = (java.util.Map<CharSequence,Long>)value$; break;
            default: throw new org.apache.avro.AvroRuntimeException("Bad index");
        }
    }
     ...
     */
    public java.util.Map<CharSequence,Integer> getIntegers() {
        return integers;
    }
     ...
     * @param value the value to set.
     */
    public void setIntegers(java.util.Map<CharSequence,Integer> value) {
        this.integers = value;
    }
     ...
     */
    public java.util.Map<CharSequence,CharSequence> getStrings() {
        return strings;
    }
     ...
     * @param value the value to set.
     */
    public void setStrings(java.util.Map<CharSequence,CharSequence> value) {
        this.strings = value;
    }
     ...
     */
    public java.util.Map<CharSequence,Long> getLongs() {
        return longs;
    }
     ...
     * @param value the value to set.
     */
    public void setLongs(java.util.Map<CharSequence,Long> value) {
        this.longs = value;
    }

    /** Creates a new InsertMutation RecordBuilder */
    public static InsertMutation.Builder newBuilder() {
        return new InsertMutation.Builder();
    }

    /** Creates a new InsertMutation RecordBuilder by copying an existing Builder */
    public static InsertMutation.Builder newBuilder(InsertMutation.Builder other) {
        return new InsertMutation.Builder(other);
    }

    /** Creates a new InsertMutation RecordBuilder by copying an existing InsertMutation instance */
    public static InsertMutation.Builder newBuilder(InsertMutation other) {
        return new InsertMutation.Builder(other);
    }
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<InsertMutation>
        ...
        private java.util.Map<CharSequence,Integer> integers;
        private java.util.Map<CharSequence,CharSequence> strings;
        private java.util.Map<CharSequence,Long> longs;
        ...
        private Builder(InsertMutation.Builder other) {
            super(other);
        ...
        /** Sets the value of the 'database' field */
        public InsertMutation.Builder setDatabase(CharSequence value) {
        ...
        public InsertMutation.Builder clearDatabase() {
            database = null;
        ...
        /** Sets the value of the 'table' field */
        public InsertMutation.Builder setTable(CharSequence value) {
        ...
        public InsertMutation.Builder clearTable() {
            table = null;
        ...
        /** Sets the value of the 'tableId' field */
        public InsertMutation.Builder setTableId(long value) {
        ...
        public InsertMutation.Builder clearTableId() {
        ...
        /** Sets the value of the 'integers' field */
        public InsertMutation.Builder setIntegers(java.util.Map<CharSequence,Integer> value) {
        ...
        public InsertMutation.Builder clearIntegers() {
            integers = null;
        ...
        /** Sets the value of the 'strings' field */
        public InsertMutation.Builder setStrings(java.util.Map<CharSequence,CharSequence> value) {
        ...
        public InsertMutation.Builder clearStrings() {
            strings = null;
        ...
        /** Sets the value of the 'longs' field */
        public InsertMutation.Builder setLongs(java.util.Map<CharSequence,Long> value) {
        ...
        public InsertMutation.Builder clearLongs() {
            longs = null;
        ...
        public InsertMutation build() {
            try {
                ...
                record.integers = fieldSetFlags()[3] ? this.integers : (java.util.Map<CharSequence,Integer>) defaultValue(fields()[3]);
                record.strings = fieldSetFlags()[4] ? this.strings : (java.util.Map<CharSequence,CharSequence>) defaultValue(fields()[4]);
                record.longs = fieldSetFlags()[5] ? this.longs : (java.util.Map<CharSequence,Long>) defaultValue(fields()[5]);
                return record;
            } catch (Exception e) {
